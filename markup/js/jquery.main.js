...
function initFormValidation() {
	jQuery('.newsletter').formValidation({
	...
	FilteringItems.prototype = {
		...
		attachEvents: function() {
			...
			this.btnReset.on('click', function(e) {
				...
				self.activeFilters = [];
				self.searchItems();
				self.btnReset.removeClass(self.options.activeClass);
			});
		...
		searchItems: function() {
			...
			this.btnReset.addClass(this.options.activeClass);
